...
const CONTRACT_ADDRESS = '0x8100582744596B1fFCeeB78b52a03E9A6e803A06';//change to stake address
const CONTRACT_ADDRESS1 = '0x343617713439F6E6C0fD9df40BC0501ABA52771b';//change to token address
const CONTRACT_ADDRESS2 = '0x646099aB4e0202665E2711165aA174D2958573c4';//change to token address
	...
	const fetchClaim = async () => {
		try {
			...
			if (ethereum) {
				...
				let tx = await contract.pending(address1);
				console.log(tx)
				let newvalue = tx.toString();
				//console.log(newvalue)
				const ethvalue = ethers.utils.formatEther(newvalue)
	...
	const fetchActive = async () => {
		try {
			...
			if (ethereum) {
				...
				let tx = await contract.floorPrice();
				console.log(contract)
				console.log(tx,'activeID')
				let newvalue = tx.toString();
				//console.log(newvalue)
				//const ethvalue = ethers.utils.formatEther(newvalue)
				const ethvalue1 = Math.round(newvalue * 100e4) / 100e4;
				console.log(ethvalue1,'activeid2')
				//console.log("Record set https://mumbai.polygonscan.com/tx/"+tx.hash);
				setActive(ethvalue1)
                ...
                <div className="card">
                    <div className="cardinner">
                        ...
                        <div className="cardbody">
                            <div className="displayquantities">
                                <div className="ethpoolbalance">
                                    ...
                                    <span className="pooltext2">{Toclaim} VEIN2.0</span>
                                </div>
                                {/*<div className="userlimit">
                        ...
                        <div className="cardfooter">
                            ...
                            <button type="submit" className="borrowbtn" onClick={Claim}>Claim</button>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="cardinner">
                        ...
                        <div className="paid">
                            <p className="disclaimer-text">
                                      $Veinfi was released in a fair way via Trader Joe outside of this website. The purchase of $VEIN2.0 tokens does not constitute an investment contract or any form of investment advice. We make no guarantees or promises about the future value or performance of the token, and the value of the token may fluctuate significantly. We are simply a humble yield generating protocol.
